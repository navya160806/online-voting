...
def render_login_view():
    try:
        # Read and convert the file explicitly from your target location
        with open("static/video/login.mp4", "rb") as video_file:
            video_bytes = video_file.read()
        base64_video = base64.b64encode(video_bytes).decode("utf-8")
        
        # Enhanced structural overrides forcing structural transparency over the viewport
        st.markdown(f"""
            <style>
                #bg-video {{
                    position: fixed;
                ...
                /* Target nested app wrappers to fully reveal the background video */
                ...
                /* Fixed card layout padding adjustments */
                [data-testid="stForm"] {{
                ...
                /* Keep font label fields readable */
        ...
        st.warning("⚠️ Local file 'static/video/login.mp4' not found. Falling back to default dark panel.")
        st.markdown("""
            <style>
    ...
    # Centered design grid framing the login form over the background layer
    ...
    with center_card:
        ...
        st.markdown("<p class='login-header'>Please authenticate to access the live voting telemetry system.</p>", unsafe_allow_html=True)
